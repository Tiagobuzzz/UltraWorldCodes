...
public class CulturalFusionTests
{
    ...
    public void FuseCulturesCombinesData()
    {
        var a = new Culture
        {
            ...
            Traditions = new List<Tradition> { new() { Name = "Saudacao", Rituals = new List<RitualInstance>() } },
        ...
        var b = new Culture
        {
            ...
            Taboos = new List<string> { "Mentir" },
            Traditions = new List<Tradition> { new() { Name = "Cerimonia", Rituals = new List<RitualInstance>() } },
